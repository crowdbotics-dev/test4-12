"""
Django settings for test4_12 project.
...
WSGI_APPLICATION = 'test4_12.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test4_12 API",
    "DESCRIPTION": "API documentation for test4_12 App",
    "VERSION": "v1",
}
